    ...
    def _build_html(self) -> str:
        ...
        <body>
            ...
            <table>
                ...
                <tr><td><strong>Total Sources</strong></td><td><strong>${self.config.sources_and_uses.total_sources:,.0f}</strong></td></tr>
            </table>
        ...
        html += f"""
            ...
            <div class="footer">
                <p>Generated by LBO Simulator v0.1.0 | Data Version: {self.config.data_version} |
                   Audit ID: {getattr(self, '_audit_id', 'N/A')}</p>
                <p>This report is for illustrative purposes only and should not be relied upon for investment decisions.</p>
            </div>
        </body>
        </html>
        """
